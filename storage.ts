...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    teamMembersData.forEach(member => {
      const id = randomUUID();
      const memberWithId = { ...member, id } as TeamMember;
      this.teamMembers.set(id, memberWithId);
    });
    ...
    const eventsData: InsertEvent[] = [
      {
        ...
        images: [
          '/images/events/ai-ml-1.jpg',
          '/images/events/ai-ml-2.jpg',
          '/images/events/ai-ml-3.jpg',
          '/images/events/ai-ml-4.jpg',
        ],
      },
      {
      ...
      },
      {
        ...
        images: [
          '/images/events/cv-1.jpg',
          '/images/events/cv-2.jpg',
          '/images/events/cv-3.jpg',
          '/images/events/cv-4.jpg',
        ],
      },
      {
        ...
        images: [
          '/images/events/dl-bootcamp-1.jpg',
          '/images/events/dl-bootcamp-2.jpg',
          '/images/events/dl-bootcamp-3.jpg',
        ],
      },
      {
        ...
        images: [
          '/images/events/competition-1.jpg',
          '/images/events/competition-2.jpg',
          '/images/events/competition-3.jpg',
          '/images/events/competition-4.jpg',
        ],
      },
      {
        ...
        images: [
          '/images/events/visit-1.jpg',
          '/images/events/visit-2.jpg',
          '/images/events/visit-3.jpg',
        ],
      },
      {
        ...
        images: [
          '/images/events/research-1.jpg',
          '/images/events/research-2.jpg',
          '/images/events/research-3.jpg',
        ],
      },
      {
        ...
        images: [
          '/images/events/fest-1.jpg',
          '/images/events/fest-2.jpg',
          '/images/events/fest-3.jpg',
          '/images/events/fest-4.jpg',
        ],
      },
      {
      ...
      },
      {
        ...
        images: [
          '/images/events/python-1.jpg',
          '/images/events/python-2.jpg',
          '/images/events/python-3.jpg',
        ],
      },
      {
        ...
        images: [
          '/images/events/ml-demo-1.jpg',
          '/images/events/ml-demo-2.jpg',
          '/images/events/ml-demo-3.jpg',
        ],
      },
    ];
